...
2.  Register it in `R/dt2_extensions.R`
    ([`.dt2_extension_registry()`](https://strategicprojects.github.io/DT2/dev/reference/dt2-extensions.md))
3.  Add auto-detection rules in
    [`.dt2_detect_extensions()`](https://strategicprojects.github.io/DT2/dev/reference/dot-dt2_detect_extensions.md)
4.  Add npm mapping in `R/dt2_check_updates.R`
    ([`.dt2_npm_map()`](https://strategicprojects.github.io/DT2/dev/reference/dot-dt2_npm_map.md))
