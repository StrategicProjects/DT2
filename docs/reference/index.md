...
- [`dt2_buttons()`](https://strategicprojects.github.io/DT2/reference/dt2_buttons.md)
  : Configure DataTables Buttons and (optionally) move them to a custom
  container

- [`dt2_check_updates()`](https://strategicprojects.github.io/DT2/reference/dt2_check_updates.md)
  : Check for DataTables library updates

- [`dt2_col_button()`](https://strategicprojects.github.io/DT2/reference/dt2_col_button.md)
  : Action button per row

- [`dt2_col_checkbox()`](https://strategicprojects.github.io/DT2/reference/dt2_col_checkbox.md)
...
- [`dt2_cols_align()`](https://strategicprojects.github.io/DT2/reference/dt2_cols_align.md)
...
- [`dt2_cols_hide()`](https://strategicprojects.github.io/DT2/reference/dt2_cols_hide.md)
  : Hide columns

- [`dt2_cols_html()`](https://strategicprojects.github.io/DT2/reference/dt2_cols_html.md)
  :
...
- [`dt2_cols_width()`](https://strategicprojects.github.io/DT2/reference/dt2_cols_width.md)
  : Column widths (CSS)

- [`dt2_draw()`](https://strategicprojects.github.io/DT2/reference/dt2_draw.md)
...
- [`dt2_format_time_format()`](https://strategicprojects.github.io/DT2/reference/dt2_format_time_format.md)
...
- [`dt2_length_menu()`](https://strategicprojects.github.io/DT2/reference/dt2_length_menu.md)
  : Length menu helper
...
- [`dt2_proxy_order()`](https://strategicprojects.github.io/DT2/reference/dt2_proxy_order.md)
  : Order the table (proxy)

- [`dt2_proxy_page()`](https://strategicprojects.github.io/DT2/reference/dt2_proxy_page.md)
  : Page navigation (proxy)

- [`dt2_proxy_search()`](https://strategicprojects.github.io/DT2/reference/dt2_proxy_search.md)
  : Global search (proxy)
...
- [`dt2_replace_data()`](https://strategicprojects.github.io/DT2/reference/dt2_replace_data.md)
...
- [`dt2_select_rows()`](https://strategicprojects.github.io/DT2/reference/dt2_select_rows.md)
...
- [`dt2_state()`](https://strategicprojects.github.io/DT2/reference/dt2_state.md)
...
- [`dt2_update_libs()`](https://strategicprojects.github.io/DT2/reference/dt2_update_libs.md)
...
- [`dt2_use_renderer()`](https://strategicprojects.github.io/DT2/reference/dt2_use_renderer.md)
  : Use a named JS renderer on columns

- [`observe_dt2_events()`](https://strategicprojects.github.io/DT2/reference/observe_dt2_events.md)
